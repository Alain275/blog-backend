...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Directory where static files will be collected by 'collectstatic'
STATICFILES_DIRS = []  # Additional directories with static files

# Media files (uploads)
MEDIA_URL = '/media/'  # URL prefix for serving media files
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Directory where media files (uploads) will be stored
